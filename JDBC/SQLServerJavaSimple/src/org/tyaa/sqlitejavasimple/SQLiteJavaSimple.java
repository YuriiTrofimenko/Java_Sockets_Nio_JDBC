...
public class SQLiteJavaSimple {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException
    {
        ...
        try
        {
            ...
            connection = DriverManager.getConnection("jdbc:sqlserver://DESKTOP-L3ET5DL\\SQLEXPRESS;"
                    + "databaseName=AspMvcDb;integratedSecurity=true");
        ...
        {
            System.out.println("Ошибка обращения к БД: " + ex.getMessage());
        }
